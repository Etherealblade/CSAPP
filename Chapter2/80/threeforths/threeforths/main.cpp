...
int threeforths(int x)
{
	...
	different from 2.79 here

	rouding to zero is a little complicated
	every int x, equals f(first 30 bit number) plus 1
	(last 2 bit number)
	...
	f doesn't care about round at all, we just care about
	rounding from l*3/4
	...
	when x<0, rouding to zero acts like divide_power2 in
	2.78
