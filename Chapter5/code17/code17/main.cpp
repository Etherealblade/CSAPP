...
void* basic_memset(void* s, int c, size_t n)
{
	...
	return s;	// s 并未经过计算，为何要返回s？
}

void* effective_memset(void* s, unsigned long cs,
	size_t n)
{
	/*
...
int main()
{
	...
	/*
	careful! malloc SIZE_MAX SIZE memory will make sys
	slow or crash down
	...
	*/
	...
	effective_memset(effective_space,
		effective_fill, space);

	assert(memcmp(basic_space,
		effective_space, space) == 0);
